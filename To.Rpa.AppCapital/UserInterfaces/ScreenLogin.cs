...
namespace Tcs.Rpa.AppCapital.Mainframe.UserInterfaces
{
    public class ScreenLogin
    {
        ...
        public void DoOperations()
        {
            ...
            */
            ...
            //MainFrameAdapter.SetTextOnScreen(6, 53, CryptSecurity.ConvertToUnsecureString(ConvertToSecureString("BFPGENJUL")));
            //MainFrameAdapter.SetTextOnScreen(7, 53, CryptSecurity.ConvertToUnsecureString(ConvertToSecureString("JUP1T3R6")));
